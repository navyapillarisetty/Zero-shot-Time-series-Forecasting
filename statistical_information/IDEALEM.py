        ...
        with open(r"/content/drive/My Drive/zero_shot_forecasting/statistical_information/stat_info_results/L1MAG_part2_encoded.csv.bin.idealem", "wb",buffering = 1000000) as idealem_file: #output to file
            ...
            while True:
                ...
                try: # converting binary to decimal
                    data=struct.unpack('d'*seq_length, binary_file.read(size))
                ...
                for i in range(min(len(distribution),numberOfbuffers)):
                    ...
                    pvalue = KolmogorovTest( seq_length, sorted(distribution[i]), seq_length, sorted(data) )
                ...
                b_data=struct.pack('d'*seq_length, *data)
                #non-exchangeable
        ...
        with open(r"/content/drive/My Drive/zero_shot_forecasting/statistical_information/stat_info_results/L1MAG_part2_decoded.csv.bin.idealem.bin", "wb") as idealem_file: # write decompressed data
            ...
            while data:
                ...
                if data[0] not in place:
                    ...
                    data1=struct.unpack('d'*seq_length, binary_file.read(size))
                    # convert decimal data to binary
                    b_data1=struct.pack('d'*seq_length,*data1)
